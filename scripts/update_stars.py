...
class GitHubDataUpdater:
    ...
    def __init__(self, data_file: str, github_token: Optional[str] = None):
    ...
    def update_repository_data(self, repo: Dict) -> Dict:
        ...
        repo["last_updated"] = repo_data.get("updated_at", repo["last_updated"])
